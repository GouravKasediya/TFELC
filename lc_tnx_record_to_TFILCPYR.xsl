    ...
    <ServiceRequest xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
      ...
      <m:TFILCPYR>
        ...
        <m:ResponseType><xsl:value-of select="if (sub_tnx_type_code = '08' or sub_tnx_type_code = '62') then 'A'
                                              ...
                                              else if (sub_tnx_type_code = '25') then 'B'
                                              else ''" /></m:ResponseType>
        <m:ResponseDetails><xsl:value-of select="if (sub_tnx_type_code = '08' or sub_tnx_type_code = '62' or sub_tnx_type_code = '25') then free_format_text else ''" />
        </m:ResponseDetails>
